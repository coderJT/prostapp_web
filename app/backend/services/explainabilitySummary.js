...
const PROSTATE_DOMAIN_GUIDANCE = [
    ...
    '- For FTIR/non-invasive predictions, group spectral/PCA components back to their source wavenumber regions. Explain the region-level biomolecular context, not individual columns as biomarkers.',
