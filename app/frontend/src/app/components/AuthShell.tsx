...
const highlightIcons = [HeartPulse, ShieldCheck, Sparkles];
const defaultHighlights = [
  'Guided risk checks with clear next steps',
  'Private access for patients and clinical teams',
  'Designed for quick, calm daily use',
];
