...
export function MedicalHistory() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl min-w-0 space-y-6 overflow-hidden">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <h1 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Medical History</h1>
          <p className="text-gray-600 dark:text-gray-400">View and manage your health records</p>
        </div>
